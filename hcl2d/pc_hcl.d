...
int tick(bool showpc=true, bool showall=false) {
    ...
    ulong _HCL_Stat = ((((((_HCL_icode)==(7)))||(((_HCL_icode)==(8))))||(((_HCL_icode)==(9)))) ? (4) :
		((_HCL_icode)==(0)) ? (2) :
		(1));
    _HCL_Stat &= 0x7;
    if (showall) writefln("set Stat to 0x%x",_HCL_Stat);
    ulong _HCL_p_pc = (((((_HCL_icode)==(0)))||(((_HCL_icode)==(1)))) ? ((_HCL_P_pc)+(1UL)) :
		(((((((_HCL_icode)==(2)))||(((_HCL_icode)==(6))))||(((_HCL_icode)==(2))))||(((_HCL_icode)==(10))))||(((_HCL_icode)==(11)))) ? ((_HCL_P_pc)+(2UL)) :
		(((((_HCL_icode)==(3)))||(((_HCL_icode)==(2))))||(((_HCL_icode)==(5)))) ? ((_HCL_P_pc)+(10UL)) :
		0);
...
pragma(msg,`Estimated clock delay: 37`);
enum tpt = 37;
