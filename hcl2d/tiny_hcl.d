...
int tick(bool showpc=true, bool showall=false) {
    ...
    ulong _HCL_reg_inputE = (((cast(ulong)(((_HCL_opcode)>>0UL)&0xf))==(0UL)) ? ((_HCL_reg_outputA)-(_HCL_opcode)) :
		((cast(ulong)(((_HCL_opcode)>>0UL)&0xf))==(1UL)) ? ((_HCL_reg_outputA)+(_HCL_opcode)) :
		((cast(ulong)(((_HCL_opcode)>>0UL)&0xf))==(2UL)) ? ((_HCL_reg_outputA)*(_HCL_opcode)) :
		((_HCL_reg_outputA)|(_HCL_opcode)));
...
pragma(msg,`Estimated clock delay: 199`);
enum tpt = 199;
