...
int tick(bool showpc=true, bool showall=false) {
    ...
    ulong _HCL_ifun = cast(ulong)(((_HCL_opcode)>>0UL)&0xf);
    _HCL_ifun &= 0xf;
    if (showall) writefln("set ifun to 0x%x",_HCL_ifun);
    ulong _HCL_rA = (((_HCL_icode)==(2)) ? (cast(ulong)(((_HCL_i10bytes)>>12UL)&0xf)) :
		((_HCL_icode)==(6)) ? (cast(ulong)(((_HCL_i10bytes)>>12UL)&0xf)) :
		0);
    _HCL_rA &= 0xf;
    if (showall) writefln("set rA to 0x%x",_HCL_rA);
    ulong _HCL_reg_srcA = _HCL_rA;
    _HCL_reg_srcA &= 0xf;
    if (showall) writefln("set reg_srcA to 0x%x",_HCL_reg_srcA);
    ulong _HCL_rB = (((_HCL_icode)==(3)) ? (cast(ulong)(((_HCL_i10bytes)>>8UL)&0xf)) :
		((_HCL_icode)==(2)) ? (cast(ulong)(((_HCL_i10bytes)>>8UL)&0xf)) :
		((_HCL_icode)==(6)) ? (cast(ulong)(((_HCL_i10bytes)>>12UL)&0xf)) :
		0);
    _HCL_rB &= 0xf;
    if (showall) writefln("set rB to 0x%x",_HCL_rB);
    ulong _HCL_reg_dstE = (((_HCL_icode)==(3)) ? (_HCL_rB) :
		((_HCL_icode)==(2)) ? (_HCL_rB) :
		((_HCL_icode)==(6)) ? (_HCL_rB) :
		(15));
    _HCL_reg_dstE &= 0xf;
    ...
    ulong _HCL_p_pc = (((_HCL_icode)==(1)) ? ((_HCL_P_pc)+(1UL)) :
		((_HCL_icode)==(2)) ? ((_HCL_P_pc)+(2UL)) :
		((_HCL_icode)==(3)) ? ((_HCL_P_pc)+(10UL)) :
		((_HCL_icode)==(4)) ? ((_HCL_P_pc)+(10UL)) :
		((_HCL_icode)==(5)) ? ((_HCL_P_pc)+(10UL)) :
		((_HCL_icode)==(6)) ? ((_HCL_P_pc)+(2UL)) :
		((_HCL_icode)==(10)) ? ((_HCL_P_pc)+(2UL)) :
		((_HCL_icode)==(11)) ? ((_HCL_P_pc)+(2UL)) :
		((_HCL_icode)==(2)) ? ((_HCL_P_pc)+(2UL)) :
		((_HCL_icode)==(7)) ? ((_HCL_P_pc)+(9UL)) :
		((_HCL_icode)==(8)) ? ((_HCL_P_pc)+(9UL)) :
		((_HCL_icode)==(9)) ? ((_HCL_P_pc)+(1UL)) :
		((_HCL_icode)==(0)) ? ((_HCL_P_pc)+(1UL)) :
		0);
    ...
    ulong _HCL_valC = (((_HCL_icode)==(3)) ? (cast(ulong)(((_HCL_i10bytes)>>16UL)&0xffffffffffffffff)) :
		((_HCL_icode)==(2)) ? (_HCL_reg_outputA) :
		(((_HCL_icode)==(6))&&((_HCL_ifun)==(0))) ? ((_HCL_reg_outputA)+(_HCL_reg_outputB)) :
    ...
    ulong _HCL_reg_inputE = (((_HCL_icode)==(3)) ? (_HCL_valC) :
		((_HCL_icode)==(2)) ? (_HCL_valC) :
		((_HCL_icode)==(6)) ? (_HCL_valC) :
		0);
    _HCL_reg_inputE &= 0xffffffffffffffff;
    if (showall) writefln("set reg_inputE to 0x%x",_HCL_reg_inputE);
    ulong _HCL_c_ZF = ((_HCL_valC)==(0UL));
    _HCL_c_ZF &= 0x1;
    if (showall) writefln("set c_ZF to 0x%x",_HCL_c_ZF);
    ulong _HCL_c_SF = ((_HCL_valC)>=(0x8000000000000000UL));
    _HCL_c_SF &= 0x1;
...
pragma(msg,`Estimated clock delay: 93`);
enum tpt = 93;
