...
int tick(bool showpc=true, bool showall=false) {
    ...
    ulong _HCL_reg_srcA = ((((((((_HCL_D_icode)==(4)))||(((_HCL_D_icode)==(2))))||(((_HCL_D_icode)==(6))))||(((_HCL_D_icode)==(2))))||(((_HCL_D_icode)==(10)))) ? (_HCL_D_rA) :
		((((_HCL_D_icode)==(11)))||(((_HCL_D_icode)==(9)))) ? (4) :
		(15));
    _HCL_reg_srcA &= 0xf;
    if (showall) writefln("set reg_srcA to 0x%x",_HCL_reg_srcA);
    ulong _HCL_reg_srcB = ((((((_HCL_D_icode)==(4)))||(((_HCL_D_icode)==(5))))||(((_HCL_D_icode)==(6)))) ? (_HCL_D_rB) :
		((((((_HCL_D_icode)==(10)))||(((_HCL_D_icode)==(8))))||(((_HCL_D_icode)==(11))))||(((_HCL_D_icode)==(9)))) ? (4) :
		(15));
    _HCL_reg_srcB &= 0xf;
    ...
    ulong _HCL_d_valP = _HCL_D_valP;
    _HCL_d_valP &= 0xffffffffffffffff;
    if (showall) writefln("set d_valP to 0x%x",_HCL_d_valP);
    ulong _HCL_e_conditionsMet = (((_HCL_E_ifun)==(0)) ? (1) :
    ...
    ulong _HCL_e_dstE = (((((_HCL_E_icode)==(2)))&&((!_HCL_e_conditionsMet))) ? (15) :
		(_HCL_E_dstE));
    _HCL_e_dstE &= 0xf;
    ...
    ulong _HCL_e_valP = _HCL_E_valP;
    _HCL_e_valP &= 0xffffffffffffffff;
    if (showall) writefln("set e_valP to 0x%x",_HCL_e_valP);
    ulong _HCL_mem_addr = (((((((_HCL_M_icode)==(4)))||(((_HCL_M_icode)==(5))))||(((_HCL_M_icode)==(10))))||(((_HCL_M_icode)==(8)))) ? (_HCL_M_valE) :
    ...
    ulong _HCL_mem_readbit = ((((_HCL_M_icode)==(5)))||(((_HCL_M_icode)==(11))))||(((_HCL_M_icode)==(9)));
    ...
    ulong _HCL_mem_input = ((((_HCL_M_icode)==(8))) ? (_HCL_M_valP) :
		(_HCL_M_valA));
    ...
    ulong _HCL_reg_inputE = (((_HCL_W_icode)==(2)) ? (_HCL_W_valM) :
		(((((((((_HCL_W_icode)==(3)))||(((_HCL_W_icode)==(6))))||(((_HCL_W_icode)==(2))))||(((_HCL_W_icode)==(10))))||(((_HCL_W_icode)==(8))))||(((_HCL_W_icode)==(11))))||(((_HCL_W_icode)==(9)))) ? (_HCL_W_valE) :
		0);
    _HCL_reg_inputE &= 0xffffffffffffffff;
    if (showall) writefln("set reg_inputE to 0x%x",_HCL_reg_inputE);
    ulong _HCL_Stat = (((_HCL_W_stat)==(0)) ? (1) :
		(_HCL_W_stat));
    _HCL_Stat &= 0x7;
    if (showall) writefln("set Stat to 0x%x",_HCL_Stat);
    ulong _HCL_loadUse = (((((_HCL_E_icode)==(5)))||(((_HCL_E_icode)==(11)))))&&(((((_HCL_E_dstM)==(_HCL_reg_srcA)))||(((_HCL_E_dstM)==(_HCL_reg_srcB)))));
    _HCL_loadUse &= 0x1;
    ...
    ulong _HCL_x_predPC = (((((_HCL_f_icode)==(7)))||(((_HCL_f_icode)==(8)))) ? (_HCL_f_valC) :
		(_HCL_f_valP));
    _HCL_x_predPC &= 0xffffffffffffffff;
    if (showall) writefln("set x_predPC to 0x%x",_HCL_x_predPC);
    ulong _HCL_mispredicted = (((((_HCL_M_icode)==(7)))&&((!_HCL_e_conditionsMet))) ? (1) :
		(0));
    _HCL_mispredicted &= 0x1;
    if (showall) writefln("set mispredicted to 0x%x",_HCL_mispredicted);
    ulong _HCL_x_pc = (((_HCL_W_icode)==(9)) ? (_HCL_W_valM) :
		(_HCL_mispredicted) ? (_HCL_M_valA) :
		(_HCL_F_predPC));
    ...
    ulong _HCL_m_valM = (((((((_HCL_M_icode)==(4)))||(((_HCL_M_icode)==(5))))||(((_HCL_M_icode)==(11))))||(((_HCL_M_icode)==(9)))) ? (_HCL_mem_output) :
		(_HCL_M_valA));
    _HCL_m_valM &= 0xffffffffffffffff;
    if (showall) writefln("set m_valM to 0x%x",_HCL_m_valM);
    _HCL_stall_F = cast(bool)(((((((_HCL_loadUse)||((_HCL_f_stat)!=(1)))||(9))==(_HCL_D_icode)))||(((((_HCL_loadUse)||((_HCL_f_stat)!=(1)))||(9))==(_HCL_E_icode))))||(((((_HCL_loadUse)||((_HCL_f_stat)!=(1)))||(9))==(_HCL_M_icode))));
    if (showall) writefln("set stall_F to %s",_HCL_stall_F);
    _HCL_bubble_D = cast(bool)((_HCL_mispredicted)||((!_HCL_loadUse)&&((((((9)==(_HCL_D_icode)))||(((9)==(_HCL_E_icode))))||(((9)==(_HCL_M_icode)))))));
    if (showall) writefln("set bubble_D to %s",_HCL_bubble_D);
    _HCL_bubble_E = cast(bool)((_HCL_loadUse)||(_HCL_mispredicted));
    ...
    if (_HCL_bubble_M) _HCL_M_valP = 0;
    else if (!_HCL_stall_M) _HCL_M_valP = _HCL_e_valP;
    ...
    if (_HCL_bubble_F) _HCL_F_predPC = 0;
    else if (!_HCL_stall_F) _HCL_F_predPC = _HCL_x_predPC;
    ...
    if (_HCL_bubble_E) _HCL_E_valP = 0;
    else if (!_HCL_stall_E) _HCL_E_valP = _HCL_d_valP;
...
pragma(msg,`Estimated clock delay: 63`);
enum tpt = 63;
...
int main(string[] args) {
	...
	write(`| register xF(`,(_HCL_bubble_F?'B':_HCL_stall_F?'S':'N'));
		writefln(`) { pc=%016x predPC=%016x }        |`, _HCL_F_pc, _HCL_F_predPC);


	write(`| register fD(`,(_HCL_bubble_D?'B':_HCL_stall_D?'S':'N'));
		writefln(`) { icode=%01x ifun=%01x rA=%01x rB=%01x stat=%01x                      |`, _HCL_D_icode, _HCL_D_ifun, _HCL_D_rA, _HCL_D_rB, _HCL_D_stat);
		writefln(`|  valC=%016x valP=%016x }                        |`, _HCL_D_valC, _HCL_D_valP);


	write(`| register dE(`,(_HCL_bubble_E?'B':_HCL_stall_E?'S':'N'));
		writefln(`) { dstE=%01x dstM=%01x icode=%01x ifun=%01x stat=%01x                  |`, _HCL_E_dstE, _HCL_E_dstM, _HCL_E_icode, _HCL_E_ifun, _HCL_E_stat);
		writefln(`|  valA=%016x valB=%016x valC=%016x    |`, _HCL_E_valA, _HCL_E_valB, _HCL_E_valC);
		writefln(`|  valP=%016x }                                              |`, _HCL_E_valP);


	write(`| register eM(`,(_HCL_bubble_M?'B':_HCL_stall_M?'S':'N'));
		writefln(`) { conditionsMet=%01x dstE=%01x dstM=%01x icode=%01x stat=%01x         |`, _HCL_M_conditionsMet, _HCL_M_dstE, _HCL_M_dstM, _HCL_M_icode, _HCL_M_stat);
		writefln(`|  valA=%016x valE=%016x valP=%016x }  |`, _HCL_M_valA, _HCL_M_valE, _HCL_M_valP);
