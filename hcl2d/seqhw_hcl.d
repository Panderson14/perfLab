...
int tick(bool showpc=true, bool showall=false) {
    ...
    ulong _HCL_reg_srcA = ((((((_HCL_icode)==(2)))||(((_HCL_icode)==(4))))||(((_HCL_icode)==(6)))) ? (_HCL_rA) :
		(15));
    _HCL_reg_srcA &= 0xf;
    if (showall) writefln("set reg_srcA to 0x%x",_HCL_reg_srcA);
    ulong _HCL_reg_srcB = (((((_HCL_icode)==(6)))||(((_HCL_icode)==(4)))) ? (_HCL_rB) :
		(15));
    _HCL_reg_srcB &= 0xf;
    ...
    ulong _HCL_mem_writebit = ((_HCL_icode)==(4));
    _HCL_mem_writebit &= 0x1;
    if (showall) writefln("set mem_writebit to 0x%x",_HCL_mem_writebit);
    ulong _HCL_reg_dstE = ((((_HCL_icode)==(2))&&(_HCL_conditionsMet)) ? (_HCL_rB) :
		((((_HCL_icode)==(3)))||(((_HCL_icode)==(6)))) ? (_HCL_rB) :
		(15));
    _HCL_reg_dstE &= 0xf;
    ...
    ulong _HCL_x_pc = ((((_HCL_icode)==(7))&&(_HCL_conditionsMet)) ? (_HCL_valC) :
		(_HCL_valP));
    ...
    ulong _HCL_valE = ((((_HCL_icode)==(6))&&((_HCL_ifun)==(0))) ? ((_HCL_reg_outputA)+(_HCL_reg_outputB)) :
		...
		(((_HCL_icode)==(4))) ? ((_HCL_valC)+(_HCL_reg_outputB)) :
		(0UL));
...
pragma(msg,`Estimated clock delay: 106`);
enum tpt = 106;
