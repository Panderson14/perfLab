...
int tick(bool showpc=true, bool showall=false) {
    ...
    ulong _HCL_valP = (((((_HCL_icode)==(0)))||(((_HCL_icode)==(1)))) ? ((_HCL_P_pc)+(1UL)) :
		(((((((_HCL_icode)==(2)))||(((_HCL_icode)==(6))))||(((_HCL_icode)==(2))))||(((_HCL_icode)==(10))))||(((_HCL_icode)==(11)))) ? ((_HCL_P_pc)+(2UL)) :
		(((_HCL_icode)==(7))) ? ((_HCL_P_pc)+(9UL)) :
		(((((_HCL_icode)==(3)))||(((_HCL_icode)==(5))))||(((_HCL_icode)==(4)))) ? ((_HCL_P_pc)+(10UL)) :
		0);
    _HCL_valP &= 0xffffffffffffffff;
    if (showall) writefln("set valP to 0x%x",_HCL_valP);
    ulong _HCL_reg_srcA = ((((((((_HCL_icode)==(2)))||(((_HCL_icode)==(6))))||(((_HCL_icode)==(2))))||(((_HCL_icode)==(4))))||(((_HCL_icode)==(10)))) ? (_HCL_rA) :
		(((_HCL_icode)==(11))) ? (4) :
		(15));
    _HCL_reg_srcA &= 0xf;
    if (showall) writefln("set reg_srcA to 0x%x",_HCL_reg_srcA);
    ulong _HCL_reg_srcB = ((((((_HCL_icode)==(6)))||(((_HCL_icode)==(4))))||(((_HCL_icode)==(5)))) ? (_HCL_rB) :
		((((_HCL_icode)==(10)))||(((_HCL_icode)==(11)))) ? (4) :
		(15));
    _HCL_reg_srcB &= 0xf;
    if (showall) writefln("set reg_srcB to 0x%x",_HCL_reg_srcB);
    ulong _HCL_conditionsMet = (((_HCL_ifun)==(0)) ? (1) :
		((_HCL_ifun)==(1)) ? ((_HCL_C_SF)||(_HCL_C_ZF)) :
		((_HCL_ifun)==(2)) ? (_HCL_C_SF) :
		((_HCL_ifun)==(3)) ? (_HCL_C_ZF) :
		((_HCL_ifun)==(4)) ? (!_HCL_C_ZF) :
		((_HCL_ifun)==(5)) ? (!_HCL_C_SF) :
		((_HCL_ifun)==(6)) ? ((!_HCL_C_SF)&&(!_HCL_C_ZF)) :
		(0));
    ...
    ulong _HCL_mem_readbit = (((((_HCL_icode)==(4)))||(((_HCL_icode)==(10)))) ? (0UL) :
		((((_HCL_icode)==(5)))||(((_HCL_icode)==(11)))) ? (1UL) :
		0);
    _HCL_mem_readbit &= 0x1;
    if (showall) writefln("set mem_readbit to 0x%x",_HCL_mem_readbit);
    ulong _HCL_mem_writebit = (((((_HCL_icode)==(4)))||(((_HCL_icode)==(10)))) ? (1UL) :
		((((_HCL_icode)==(5)))||(((_HCL_icode)==(11)))) ? (0UL) :
		0);
    ...
    ulong _HCL_reg_dstE = (((!_HCL_conditionsMet)&&((_HCL_icode)==(2))) ? (15) :
		((((((_HCL_icode)==(3)))||(((_HCL_icode)==(2))))||(((_HCL_icode)==(6))))||(((_HCL_icode)==(2)))) ? (_HCL_rB) :
		((((_HCL_icode)==(10)))||(((_HCL_icode)==(11)))) ? (4) :
		(((_HCL_icode)==(5))) ? (_HCL_rA) :
		(15));
    _HCL_reg_dstE &= 0xf;
    if (showall) writefln("set reg_dstE to 0x%x",_HCL_reg_dstE);
    ulong _HCL_reg_dstM = ((((_HCL_icode)==(11))) ? (_HCL_rA) :
		0);
    _HCL_reg_dstM &= 0xf;
    if (showall) writefln("set reg_dstM to 0x%x",_HCL_reg_dstM);
    ulong _HCL_p_pc = ((((_HCL_icode)==(7))&&(_HCL_conditionsMet)) ? (_HCL_valC) :
		(_HCL_valP));
    ...
    ulong _HCL_valA = (((((((((_HCL_icode)==(2)))||(((_HCL_icode)==(6))))||(((_HCL_icode)==(2))))||(((_HCL_icode)==(4))))||(((_HCL_icode)==(10))))||(((_HCL_icode)==(11)))) ? (_HCL_reg_outputA) :
		(0UL));
    _HCL_valA &= 0xffffffffffffffff;
    if (showall) writefln("set valA to 0x%x",_HCL_valA);
    ulong _HCL_valB = ((((((((_HCL_icode)==(6)))||(((_HCL_icode)==(4))))||(((_HCL_icode)==(5))))||(((_HCL_icode)==(10))))||(((_HCL_icode)==(11)))) ? (_HCL_reg_outputB) :
		(0UL));
    _HCL_valB &= 0xffffffffffffffff;
    if (showall) writefln("set valB to 0x%x",_HCL_valB);
    ulong _HCL_valE = ((((_HCL_icode)==(3))) ? (_HCL_valC) :
		((((_HCL_icode)==(2)))||(((_HCL_icode)==(2)))) ? (_HCL_valA) :
		((((_HCL_icode)==(4)))||(((_HCL_icode)==(5)))) ? ((_HCL_valB)+(_HCL_valC)) :
		(((_HCL_icode)==(10))) ? ((_HCL_valB)-(8UL)) :
		(((_HCL_icode)==(11))) ? ((_HCL_valB)+(8UL)) :
		(((_HCL_icode)==(6))&&((_HCL_ifun)==(3))) ? ((_HCL_valA)^(_HCL_valB)) :
		(((_HCL_icode)==(6))&&((_HCL_ifun)==(0))) ? ((_HCL_valA)+(_HCL_valB)) :
		(((_HCL_icode)==(6))&&((_HCL_ifun)==(1))) ? ((_HCL_valB)-(_HCL_valA)) :
		(((_HCL_icode)==(6))&&((_HCL_ifun)==(2))) ? ((_HCL_valA)&(_HCL_valB)) :
		(0UL));
    ...
    ulong _HCL_mem_addr = ((((((_HCL_icode)==(4)))||(((_HCL_icode)==(5))))||(((_HCL_icode)==(10)))) ? (_HCL_valE) :
		(((_HCL_icode)==(11))) ? (_HCL_valA) :
		0);
    _HCL_mem_addr &= 0xffffffffffffffff;
    if (showall) writefln("set mem_addr to 0x%x",_HCL_mem_addr);
    ulong _HCL_mem_input = (((((_HCL_icode)==(4)))||(((_HCL_icode)==(10)))) ? (_HCL_valA) :
		0);
    ...
    ulong _HCL_valM = (((((_HCL_icode)==(5)))||(((_HCL_icode)==(11)))) ? (_HCL_mem_output) :
		0);
    _HCL_valM &= 0xffffffffffffffff;
    if (showall) writefln("set valM to 0x%x",_HCL_valM);
    ulong _HCL_reg_inputE = (((!_HCL_conditionsMet)&&((_HCL_icode)==(2))) ? (0UL) :
		((((((((_HCL_icode)==(3)))||(((_HCL_icode)==(2))))||(((_HCL_icode)==(6))))||(((_HCL_icode)==(2))))||(((_HCL_icode)==(10))))||(((_HCL_icode)==(11)))) ? (_HCL_valE) :
		(((_HCL_icode)==(5))) ? (_HCL_valM) :
		(0UL));
    _HCL_reg_inputE &= 0xffffffffffffffff;
    if (showall) writefln("set reg_inputE to 0x%x",_HCL_reg_inputE);
    ulong _HCL_reg_inputM = ((((_HCL_icode)==(11))) ? (_HCL_valM) :
		0);
...
pragma(msg,`Estimated clock delay: 142`);
enum tpt = 142;
